...
// #include <opencv2/cudastereo.hpp>  // CUDA disabled - using CPU StereoSGBM instead
...
private:
    ...
    // Using CPU StereoSGBM instead of CUDA StereoSGM
    cv::Ptr<cv::StereoSGBM> m_sgbm_ptr = cv::StereoSGBM::create(0, 64, 10, 120, 120*10, 15);
